...
- If users explicitly ask to provide the sql query provide only the last sql query that was used to generate the results
...
""",
        tools=[
            agents.function_tool(
                run_bigquery_query,
                name_override="run_bigquery_query",
            )
        ],
        model=model,
    )
